    ...
    <section id="about" className="py-40 px-6 max-w-7xl mx-auto relative">
      ...
      <div className="grid md:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          >
            I don’t just learn to code.<br />
            I code to <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 font-bold">change lives</span> — one line at a time.
          </motion.p>
        </motion.div>
      </div>
    </section>
